# ---------------------------------------------------------
# VERSION: V2.21 (Engine Swap & Pose Unlock)
# TIMESTAMP: 2026-02-13 22:40 WET (Almada, PT)
# CHANGELOG:
# - Added Header with Version/Date.
# - Switched GEN_MODEL to 'gemini-2.0-flash-exp' to bypass Error 429.
# - Maintained V2.20 logic (Pose Unlocked, Reference Image for Dress).
# ---------------------------------------------------------
...
# --- MODELLI ---
# VISION: Rimane il flash-preview per l'analisi veloce
VISION_MODEL = "models/gemini-2.0-flash-exp" 
# GENERATION: Passiamo al 2.0 Flash Exp che ha quote API più stabili del 3-preview
GEN_MODEL = "models/gemini-2.0-flash-exp"
...
def show_settings(m):
    bot.send_message(m.chat.id, "<b>👗 Valeria Closet Settings (V2.21)</b>\nScegli il formato e il numero di scatti:", 
...
def handle_reply_edit(m):
    ...
    if file_id:
        bot.reply_to(m, "🔄 Elaborazione modifica (Engine V2.21)...")
...
@app.route('/')
def h(): return "Bot Online - V2.21 (Flash Engine)"
