...
FILTERS = {
    ...
    "ghost_temporal": {
        ...
        "prompt": (
            ...
            "OUTFIT: The subject wears an oversized highly textured bomber jacket with eclectic abstract patchwork pattern "
            "in muted and vivid reds, blues, greens, and beiges — paired with loose drab olive cargo pants and a white T-shirt. "
            "Keep the subject's original outfit only if it is clearly more distinctive; otherwise use the described outfit. "
    ...
    "selfie_stick": {
        ...
        "use_master": False,
        "prompt": (
            "Using the uploaded photo as the identity and style reference, create a single ultra-realistic image. "
            "CAMERA SETUP: Extreme wide-angle fisheye POV shot from a selfie stick or Insta360 camera. "
            "The selfie stick is physically held in the subject's RIGHT hand, arm fully extended upward and forward toward the camera. "
            "The stick must be visibly gripped by the right hand — the hand wraps around the handle at the bottom of the stick. "
            "The camera sits at the TOP of the stick, 2-3 meters above and in front of the subject, pointing downward. "
            "The LEFT arm hangs naturally at the side or rests casually — it does NOT hold anything. "
            "Strong fisheye distortion on the edges of the frame. The subject looks up into the lens with a natural, candid expression. "
            "FRAMING: The subject fills the lower-center of the frame. The environment extends dramatically around and behind them. "
            "The top portion of the stick is visible entering the frame from above. "
            ...
            "SCENE: The environment is derived from the uploaded photo's background. "
            "If no clear background is visible, choose one of these at random: "
            "a wide sandy beach with waves, a blooming wildflower meadow, a colorful city street, a mountain trail with a panoramic view. "
            ...
            "No studio lighting, no bokeh, no tripod stability. Cinematic 1:1 aspect ratio. "
    ...
    "directors_cut": {
        ...
        "prompt": (
            ...
            "Keep each person's key identity traits consistent: face structure, hairstyle, facial hair, "
            "makeup level, body proportions, age range, skin tone, and distinctive features. "
            "Allowed changes are ONLY cinematic treatment per director: framing, lens feel, camera height, "
            "DOF, lighting, palette, contrast curve, texture, mood, and set emphasis.\n\n"
            "Director styles:\n"
