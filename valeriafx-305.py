...
FILTERS = {
    ...
    "fullbody_3x3": {
        ...
        "prompt": (
            ...
            "9 full body poses in order: "
            "1-confident frontal stance hands on hips direct gaze, "
            "2-three-quarter turn left hand on waist looking over shoulder, "
            "3-full rear view looking back at camera, "
            "4-low angle shot from below dramatic perspective subject looking down at camera, "
            "5-side profile elegant posture chin slightly raised, "
            "6-dynamic walking pose mid-stride natural movement, "
            "7-seated on floor legs extended arms behind relaxed editorial pose, "
            "8-leaning against wall one foot raised casual elegant, "
            "9-arms raised overhead full body stretch triumphant pose. "
