...
VALERIA_IDENTITY = (
    ...
    "**Facial identity:**\n"
    "60-year-old Italian male face, oval-rectangular shape. Ultra-detailed mature skin texture with visible pores, "
    "deep-set character wrinkles, crow's feet. Calm half-smile, no teeth. "
    "Thin octagonal Vogue Havana dark tortoiseshell frame eyeglasses (MANDATORY, always present).\n\n"
    "**Hair:**\n"
    "Short silver Italian cut, slightly voluminous top, nape exposed. "
    "Silver-grey beard approximately 6-7cm, perfectly groomed, following the jawline.\n\n"
    "**Subject body:**\n"
    "Feminine hourglass proportions, 180cm, 85kg, full D-cup bust. "
    "Completely hairless body — NO body hair, NO chest hair, NO arm hair, NO leg hair on ALL surfaces. "
    "Smooth porcelain skin. Sculptural hourglass silhouette — defined waist, wide hips, full rounded figure. "
    ...
    "Full photographic coherence: unified exposure, unified color grade, unified depth of field.\n\n"
    ...
    "**NEGATIVE PROMPT — HAIR:** long hair, feminine hairstyle, bun, ponytail, black hair, blonde hair, brown hair, curly hair, flowing hair, hair on shoulders, body hair, chest hair, arm hair.\n"
    "**NEGATIVE PROMPT — BODY:** male flat chest, masculine frame, blurry hands, extra fingers, mismatched skin tone, disconnected face, faceswap artifacts, body hair, chest hair, peli.\n"
    "**NEGATIVE PROMPT — SAFETY:** JSON output, text output, captions, metadata blocks, structured data. IMAGE GENERATION ONLY. NO JSON LEAKAGE.\n"
)
...
FILTERS = {
        ...
        "variants": [
            ...
            },
            {
                ...
                "scene": (
                    ...
                    "Full body framing, showing the person entirely from feet to face so the swimwear is completely visible. "
                    "A colorful towel (no complex patterns) under the body. No chairs, deck chairs or foreign objects.\n\n"
                    "**Lighting:** Golden hour sunset over the ocean, warm golden-orange tones, long soft shadows, glowing rim light on skin.\n\n"
                    "**Expression:** Authentic, calm and relaxed facial expression, natural smile involving the eyes and small expression wrinkles.\n\n"
                    "**Technical:** 8K ultra-realistic, simulated 50mm focal length — face MUST NOT be distorted, elongated or deformed by perspective (no fish-eye effect). "
                    "f/2.8, ISO 200, 1/160s, creamy bokeh, glossy hyper-detailed finish, never waxy or plastic.\n\n"
                    "**NEGATIVE PROMPT — EXTRA:** visible phone, fish-eye lens, wide angle distortion, static, stiff, body hair on arms legs chest.\n"
                ),
            },
        ],
    },
    ...
    "riviera_60": {
        ...
        "scene": (
            ...
            "**Lighting:** Warm vintage summer light, slightly overexposed highlights typical of 1960s film photography, "
            "golden and slightly faded color palette — Kodachrome film aesthetic.\n\n"
            "**Outfit:** Vintage-inspired elegant swimwear or resort wear with retro 1960s aesthetic "
            "faithfully extracted from the reference image provided.\n\n"
            "**Framing:** Classic editorial composition, medium to full body, "
            "slightly grainy vintage film texture, warm faded color grade. "
            "Timeless, iconic, cinematic.\n\n"
            "**NEGATIVE PROMPT — EXTRA:** body hair, chest hair, arm hair, leg hair, peli, modern architecture, digital look, cold tones.\n"
        ),
    },
    "pool_party": {
        "label": "🌊 Pool Party",
...
def build_full_prompt(filter_key, outfit_description, ratio, scene_override=None):
    """Assembla il prompt completo: identità Valeria + scena filtro + outfit + formato."""
    ...
    # Numero foto scelto
        ...
        if reuse:
            ...
            if is_dual:
                ...
                pending_prompts[uid] = {'is_dual': True, 'variants': variant_list, 'count': 2}
            else:
                full_p = build_full_prompt(flt, outfit_desc, settings['ratio'])
                pending_prompts[uid] = {'is_dual': False, 'full_p': full_p, 'count': new_count}
            try:
                bot.edit_message_text(
