...
def generate_closet(m):
    ...
    try:
        # 1. Sintesi testo (Gemini 2.0 Flash)
        ...
        # Inserimento esplicito del formato nel prompt (Metodo Vogue)
        ...
        # 2. Generazione Immagine (Loop basato sulla quantità)
        for i in range(settings['count']):
            ...
            # 3. Estrazione ed invio (Metodo Vogue)
