    ...
    if callable(raw):
        ...
        if fkey == "directors_cut":
            ...
            return (
                ...
                "LABELS: Each tile has a label in italic lowercase, centered at the bottom of the tile, small font size, "
                ...
                "What changes per tile: ONLY the background environment, setting, lighting direction, color palette, and mood. "
                "The subject is transported into each director's cinematic world but remains physically identical to the original photo.\n\n"
                f"Director styles:\n{briefs}\n\n"
