# ---------------------------------------------------------
# VERSION: V2.23 (Gemini 2.0 Flash Stable)
# TIMESTAMP: 2026-02-13 22:55 WET
# CHANGELOG:
# - Switched GEN_MODEL to 'models/gemini-2.0-flash' (Removed -exp suffix to fix 404).
# - Maintained V2.20 logic (Pose Unlock, Reference Image for Dress).
# - Retained Header & Settings Menus.
# ---------------------------------------------------------
...
# --- MODELLI ---
# VISION: Flash standard
VISION_MODEL = "models/gemini-2.0-flash" 
# GENERATION: Flash standard (Versione Stabile, no preview/exp)
...
def show_settings(m):
    bot.send_message(m.chat.id, "<b>👗 Valeria Closet Settings (V2.23)</b>\nScegli il formato e il numero di scatti:", 
...
def handle_reply_edit(m):
    ...
    if file_id:
        bot.reply_to(m, "🔄 Elaborazione modifica (V2.23)...")
...
@app.route('/')
def h(): return "Bot Online - V2.23 (Flash Stable)"
