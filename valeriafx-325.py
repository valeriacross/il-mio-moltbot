...
FILTERS = {
    ...
    "selfie_stick": {
        ...
        "prompt": (
            ...
            "The camera sits at the TOP of the stick, 2-3 meters above and in front of the subject, pointing downward at the subject. "
            "The LEFT arm hangs naturally at the side or rests casually — it does NOT hold anything. "
            "Strong fisheye barrel distortion on the edges of the frame. The subject looks up into the lens with a natural smile. "
            "FRAMING: Bird's eye perspective — the subject is seen from above. "
            "The environment extends dramatically in all directions around the subject. "
            "The top portion of the stick is visible entering the frame from the top edge. "
