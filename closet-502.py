...
B3 = (
    ...
    "The subject's face, skin tone, body proportions and lighting must be fully unified and coherent: "
    "same light direction, same color temperature, same shadow density on face AND body AND outfit. "
    "No visible seam between face and neck. No mismatched skin tones. "
...
NEG = "NEGATIVE PROMPTS: female face, smooth ageless skin, body hair, masculine body shape, flat chest, mismatched skin tone, disconnected face, faceswap artifacts, copied pose from reference, identical framing to reference."
