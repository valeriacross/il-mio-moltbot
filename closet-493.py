...
B3 = "BLOCK 3 (Action): MANDATORY: Keep the EXACT OUTFIT from REFERENCE 2. Apply the SCENE instructions from the text prompt while maintaining character consistency. LANGUAGE RULE: The entire prompt output must be in English only. Translate any non-English input automatically."
