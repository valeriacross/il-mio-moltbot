...
FILTERS = {
    ...
    "photobooth_4x4": {
        ...
        "use_master": False,
        "prompt": (
            "Color photobooth expression grid, 4x4 layout, 16 panels total. Same subject in every frame: "
            "nameless Italian transmasculine editorial figure, strong Italian male face ~60yo, oval-rectangular, "
            "ultra-detailed skin texture with visible pores and expression lines, groomed light grey/silver beard 6-7cm, "
            "mandatory thin octagonal Vogue frames Havana dark tortoiseshell, light grey/silver short voluminous Italian cut hair "
            "sides 1-2cm nape exposed. Plain neutral light gray backdrop, no props. "
            "Direct photobooth flash lighting, front flash slightly hard but flattering, soft short shadow behind subject. "
            "50mm lens, tight head and shoulders framing, eyes sharp in every panel, natural realistic skin tones, "
            "medium-high contrast, subtle authentic analog photobooth grain in color, clean edges, crisp sharpness. "
            "Simple white top, clean neckline. Thin gutters between panels, high panel consistency. "
