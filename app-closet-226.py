# ---------------------------------------------------------
# VERSION: V2.26 (The Resurrection)
# TIMESTAMP: 2026-02-14 08:45 WET
# ENGINE: models/gemini-3-pro-image-preview (Quota Reset Verified)
# LOGIC: Pose Unlocked + Full Safety Bypass + Settings Menus
# ---------------------------------------------------------
...
# --- MODELLI (Il Ritorno del Re) ---
VISION_MODEL = "models/gemini-3-flash-preview"
# Torniamo all'unico modello che supporta Image-to-Image di alta qualità
...
def show_settings(m):
    bot.send_message(m.chat.id, "<b>👗 Valeria Closet V2.26</b>\nScegli il formato e il numero di scatti:", 
    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            config=genai_types.GenerateContentConfig(
                ...
                # SBLOCCO SAFETY COMPLETO (Tutte le categorie)
                safety_settings=[
...
def handle_reply_edit(m):
    ...
    if file_id:
        bot.reply_to(m, "🔄 Elaborazione modifica (V2.26)...")
