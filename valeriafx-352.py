...
FILTERS = {
    ...
    "cloud_sculpture": {
        ...
        "prompt": (
            ...
            "into a sculptural form composed entirely of soft, atmospheric clouds. "
            "SUBJECT LOCK: The subject is whoever or whatever appears in the uploaded image. "
            "Do not substitute, replace, or invent a different subject. Preserve their exact silhouette, posture, and defining features. "
