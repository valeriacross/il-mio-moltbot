...
FILTERS = {
    ...
    "selfie_stick": {
        ...
        "prompt": (
            ...
            "CAMERA SETUP: Extreme wide-angle fisheye POV shot from a selfie stick or Insta360 camera held 2-3 meters above and in front of the subject. "
            "The camera arm or stick is visible at the top of the frame, extending down toward the subject. "
            "Strong fisheye distortion on the edges of the frame. The subject looks up into the lens with a natural, candid expression. "
            "FRAMING: The subject fills the lower-center of the frame. The environment extends dramatically around and behind them in all directions. "
            ...
            "Natural outdoor lighting. Wind-blown hair and clothing for movement. "
