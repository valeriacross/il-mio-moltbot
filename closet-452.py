...
def ask_confirmation(m):
    ...
    # MODIFICA: Se è una foto e non c'è testo, usa un prompt di default per non fermarsi
    if m.content_type == 'photo':
        wait = bot.send_message(cid, "📥 <b>Elaborazione immagine in corso...</b>")
        idea = m.caption if m.caption else "Detailed scene following the reference image"
