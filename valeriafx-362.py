...
def assemble_mosaic(original_bytes, tile_results):
    ...
    tw, th = orig.size  # tile size = dimensione originale
                ...
                try:
                    ...
                    if response.candidates and response.candidates[0].finish_reason == "STOP":
                        ...
                        if attempt < MAX_RETRIES and reserve_pool:
                            # Pesca un filtro di riserva non ancora tentato per questa tile
                            ...
                            if unused_reserve:
                                ...
                                continue  # riprova con il nuovo filtro
                except Exception as e:
